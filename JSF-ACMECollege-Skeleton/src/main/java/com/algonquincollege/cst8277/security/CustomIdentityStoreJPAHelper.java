...
public class CustomIdentityStoreJPAHelper {
    ...
    public SecurityUser findUserByName(String username) {
        ...
        try {
            // Create a TypedQuery using the named query defined in SecurityUser entity
            // The named query is: SecurityUser.SECURITY_USER_BY_NAME = "SecurityUser.userByName"
            ...
            // The named query expects a parameter called "username" (see SecurityUser.java)
            ...
            // This is expected when no user is found - not an error
